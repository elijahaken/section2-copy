...
app.post('/add', async (req, res) => {
    try {
        ...
        const {
            ...
            relationshipstatus,
            occupationstatus,
            locationid_userinfo, // Foreign key reference to LocationInfo(LocationID)
            socialmediaplatformid_user, // Foreign key reference to SocialMediaPlatformInfo(SocialMediaPlatformID)
            organizationaffiliationid_user, // Foreign key reference to OrganizationAffInfo(OrganizationAffiliationID)
            overallresponseid,
            userid_overallresponse, // Foreign key reference to UserInfo(UserID)
            ...
            userid_socialmediaresponse, // Foreign key reference to UserInfo(UserID)
            smusage,
            averagetimesmperday,
            smwithoutpurpose,
            distractedbysm,
        ...
        await knex('socialmediaplatforminfo').insert({
            socialmediaplatformid: uniqueId, // replace with an actual unique ID
            socialmediaplatform: 'SomePlatform', // replace with the actual platform
        });
        ...
        await knex('userinfo').insert({
            ...
            relationshipstatus,
            occupationstatus,
            locationid: locationid_userinfo,
        });
